        ...
        <tbody>
            @forelse($orders as $order)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admins.orders.show', $order->id) }}" class="btn btn-sm btn-info">Xem</a>
                        <form action="{{ route('admins.orders.update', $order->id) }}" method="POST" style="display: inline;">
                            @csrf
                            @method('PUT')
