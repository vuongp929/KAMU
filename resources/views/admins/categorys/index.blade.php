...
@section('content')
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <a href="{{ route('admins.categorys.create') }}" class="btn btn-primary">
    ...
    <div class="d-flex gap-2">
        {{-- Nút sửa --}}
        <a href="{{ route('admins.categorys.edit', $item) }}" 
        ...
        {{-- Nút xóa --}}
        <form method="POST" action="{{ route('admins.categorys.destroy', $item) }}" 
