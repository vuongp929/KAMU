                    ...
                    <div class="order-summary">
                        ...
                        <div class="order-item">
                            <div class="item-details">
                                ...
                                <div class="item-info">
                                    <div class="product-name">{{ $item->variant->product->name ?? 'Sản phẩm không tồn
                                        tại' }}</div>
                        ...
                        <div class="discount-section mt-3">
                            <div class="input-group">
                                <input type="text" name="discount_code" class="form-control"
                                    placeholder="Nhập mã giảm giá" value="{{ old('discount_code') }}"
                                    id="discount-code-input">
                                <button type="button" class="btn btn-outline-primary" id="apply-discount-btn">
                                    Áp dụng
                                </button>
                            </div>
                            <div id="discount-message" class="mt-2"></div>
