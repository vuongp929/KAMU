...
use App\Http\Controllers\CheckoutController as ClientCheckoutController;
...
Route::get('/test',[ClientCheckoutController::class, 'test'])->name('test');
Route::post('/momo_payment', [ClientCheckoutController::class, 'momo_payment'])->name('momo_payment');
Route::get('/checkout/momo/return', [CheckoutController::class, 'handleMomoReturn'])->name('client.checkout.momo.return');
// === DEBUG ROUTE ===
